...
// --- SLIDER ---
const sliderImages = [
  { src: "img/ref-4.jpg", alt: "Referenz 4",text: "Text zu Bild 4" },
  { src: "img/ref-5.jpg", alt: "Referenz 5",text: "Text zu Bild 4" },
  { src: "img/ref-6.jpg", alt: "Referenz 6",text: "Text zu Bild 4" },
  { src: "img/ref-7.jpg", alt: "Referenz 7",text: "Text zu Bild 4" },
  { src: "img/ref-8.jpg", alt: "Referenz 8",text: "Text zu Bild 4" },
  { src: "img/ref-9.jpg", alt: "Referenz 9",text: "Text zu Bild 4" },
  { src: "img/ref-10.jpg", alt: "Referenz 10",text: "Text zu Bild 4" },
  { src: "img/ref-13.jpg", alt: "Referenz 13",text: "Text zu Bild 4" }
];
